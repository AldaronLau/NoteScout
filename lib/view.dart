      ...
      left.add(FlatButton(
        ...
        onPressed: () async {
          ...
          await showDialog(
            context: context,
            builder: (_) {
              return RateNotePopUp(state: this);
            },
          );
          setState(() {
            if (notification == null) {
...
class RateNotePopUp extends StatefulWidget {
  ViewNotePageState state;

  RateNotePopUp({Key key, this.state}) : super(key: key);

  @override
  RateNotePopUpState createState() {
    return new RateNotePopUpState();
  }
}

class RateNotePopUpState extends State<RateNotePopUp> {
  int new_rating;
...
class DeleteNotePopUp extends StatefulWidget {
  DeleteNotePopUp({Key key}) : super(key: key);

  @override
  DeleteNotePopUpState createState() {
    return new DeleteNotePopUpState();
  }
}

class DeleteNotePopUpState extends State<DeleteNotePopUp> {
  @override
  Widget build(BuildContext context) {
    return new AlertDialog(
...
class RenameNotePopUpState extends State<RenameNotePopUp> {
